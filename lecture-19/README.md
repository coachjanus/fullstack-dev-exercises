...
## Exercises for lecture #19 - Components

1. В середині exercises створіть піддирексторію lecture-19. В середині lecture-19 створіть файли index.html, css/main.css та js/main.js. 
